...
public class Login extends BasePage {
	...
	public static By finish_button() {
		return CommonDef.locatorValue(Locators.XPATH, "//button[@value='Finish']");
	}
	...
	public static By login_viewmyaccounts() {
		return CommonDef.locatorValue(Locators.XPATH,"//button[@value='View my accounts']");
	}
	...
	public static By logout_button() {
		return CommonDef.locatorValue(Locators.XPATH, "//button[@value='Logout']");
	}
